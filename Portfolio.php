...
<header>
      ...
      <section class="intro" id="home">
          ...
          <img src="Portfolio01/img/Joshua.png" alt="Wearing a toga">
      </section>
      ...
      <section class="my-services" id="services"> 
        ...
        <section class="about-me" id="about">
          ...
          <img src="Portfolio01/img/Joshua01.png" alt="Joshua wearing barong">
        </section>
        ...
        <section class="my-work" id="work">
          ...
          <div class="portfolio">
            ...
            <a href="#" class="portfolio__item">
              <img src="Portfolio01/img/Portfolio-01.jpg" alt="" class="portfolio__img">
            </a>
            <!-- Portfolio item 02 -->
            <a href="#" class="portfolio__item">
              <img src="Portfolio01/img/Portfolio-02.jpg" alt="" class="portfolio__img">
            </a>
            <!-- Portfolio item 03 -->
            <a href="#" class="portfolio__item">
              <img src="Portfolio01/img/Portfolio-03.jpg" alt="" class="portfolio__img">
            </a>
            <!-- Portfolio item 04 -->
            <a href="#" class="portfolio__item">
              <img src="Portfolio01/img/Portfolio-04.jpg" alt="" class="portfolio__img">
            </a>
            <!-- Portfolio item 05 -->
            <a href="#" class="portfolio__item">
              <img src="Portfolio01/img/Portfolio-05.jpg" alt="" class="portfolio__img">
            </a>
            <!-- Portfolio item 06 -->
            <a href="#" class="portfolio__item">
              <img src="Portfolio01/img/Portfolio-06.jpg" alt="" class="portfolio__img">
            </a>
            <!-- Portfolio item 07 -->
            <a href="#" class="portfolio__item">
              <img src="Portfolio01/img/Portfolio-07.jpg" alt="" class="portfolio__img">
            </a>
            <!-- Portfolio item 08 -->
            <a href="#" class="portfolio__item">
              <img src="Portfolio01/img/Portfolio-08.jpg" alt="" class="portfolio__img">
            </a>
            <!-- Portfolio item 09 -->
            <a href="#" class="portfolio__item">
              <img src="Portfolio01/img/Portfolio-09.jpg" alt="" class="portfolio__img">
            </a>
            <!-- Portfolio item 10 -->
            <a href="#" class="portfolio__item">
              <img src="Portfolio01/img/Portfolio-10.jpg" alt="" class="portfolio__img">
            </a>
          </div>
        </section>
